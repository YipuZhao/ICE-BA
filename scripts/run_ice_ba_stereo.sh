...
cmd="../bin/ice_ba --imgs_folder $EuRoC_PATH/$Sequence --start_idx 0 --end_idx -1 --iba_param_path ../config/config_of_stereo.txt  --gba_camera_save_path $EuRoC_PATH/result/$Sequence.txt --stereo --save_feature"
echo $cmd
eval $cmd
