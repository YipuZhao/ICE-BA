...
SeqNameList = ['room1_512_16', 'room2_512_16', 'room3_512_16', 'room4_512_16', 'room5_512_16', 'room6_512_16', \
'magistrale1_512_16', 'magistrale2_512_16', 'magistrale3_512_16', 'magistrale4_512_16', 'magistrale5_512_16', 'magistrale6_512_16'];

Result_root = '/mnt/DATA/tmp/TUM_VI/ORB2_Stereo_Baseline/'
...
Number_GF_List = [800, 1000, 1500, 2000]; # [600, 800, 1000, 1500, 2000]; #
Num_Repeating = 10 # 1 # 
# SleepTime = 2 # 10 # 25
...
for ri, num_gf in enumerate(Number_GF_List):
    ...
    for iteration in range(0, Num_Repeating):
        ...
        for sn, sname in enumerate(SeqNameList):
            ...
            Path_Image   = '/mnt/DATA/Datasets/TUM_VI/' + SeqName + '/'
            File_traj = Experiment_dir + '/' + SeqName
            File_map = File_traj + '_Map/'

            Path_Image   = '/media/yipuzhao/1399F8643500EDCD/TUM_VI/dataset-' + SeqName + '/mav0/'
            File_traj = Experiment_dir + '/' + SeqName

            # enable viz
            # cmd_slam   = str('../Examples/Stereo/stereo_general ' + File_Vocab + ' ' + File_Setting + ' ' \
            #     + str(int(num_gf)*2) + ' true ' + Path_Image + ' ' + str(0) + ' ' \
            #     + str(9999) + ' ' + File_traj + ' ' + File_map)
            # disable viz
            cmd_slam   = str('../Examples/Stereo/stereo_general ' + File_Vocab + ' ' + File_Setting + ' ' \
                + str(int(num_gf)*2) + ' false ' + Path_Image + ' ' + str(0) + ' ' \
                + str(9999) + ' ' + File_traj + ' ' + File_map)
