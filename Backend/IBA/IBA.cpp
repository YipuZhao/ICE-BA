...
// Yipu
void Solver::saveLogging(const std::string &filename) {
    ...
    fFrameLog << std::fixed;
    fFrameLog << "#frame_time_stamp time_feature time_poseTrack time_windowOpt time_total local_frame_num feature_num" << std::endl;
